package com.example.app_kawabanga
...
import com.example.app_kawabanga.databinding.ActivityMainBinding
import com.example.app_kawabanga.model.Pedido

class MainActivity : AppCompatActivity() {
    private lateinit var binding: ActivityMainBinding

    var formaDePagamentosSelecionada = ""
    ...
    fun calcular(view: View) {
        ...
        when (idSelecionado) {
            R.id.rbPequena -> {
                ...
                var tamanhoSelecionado = binding.rbPequena.text.toString()
            }
            R.id.rbMedia -> {
                valorTamanhoPizza = 12
                var tamanhoSelecionado = binding.rbMedia.text.toString()
            }
            R.id.rbGrande -> {
                valorTamanhoPizza = 15
                var tamanhoSelecionado = binding.rbGrande.text.toString()
            }
        }
